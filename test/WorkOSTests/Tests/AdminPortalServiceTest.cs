...
namespace WorkOSTests
{
    ...
    public class AdminPortalServiceTest
    {
        ...
        public async Task TestError401()
        {
            ...
            await Assert.ThrowsAsync<AuthenticationError>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
        ...
        public async Task TestError404()
        {
            ...
            await Assert.ThrowsAsync<NotFoundError>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
