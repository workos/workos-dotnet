...
namespace WorkOSTests
{
    ...
    public class AdminPortalServiceTest
    {
        ...
        public async Task TestError401()
        {
            ...
            await Assert.ThrowsAsync<AuthenticationException>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
        ...
        public async Task TestError404()
        {
            ...
            await Assert.ThrowsAsync<NotFoundException>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
        ...
        public async Task TestError422()
        {
            ...
            await Assert.ThrowsAsync<UnprocessableEntityException>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
        ...
        public async Task TestError429()
        {
            ...
            await Assert.ThrowsAsync<RateLimitExceededException>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
        ...
        public async Task TestError500()
        {
            ...
            await Assert.ThrowsAsync<ServerException>(() => this.service.GenerateLink(new AdminPortalGenerateLinkOptions()));
        }
    }
}
