...
namespace WorkOSTests
{
    ...
    public class ApiKeysServiceTest
    {
        ...
        {
            var fixture = System.IO.File.ReadAllText("testdata/list_organization_api_key.json");
        ...
        {
            var fixture = System.IO.File.ReadAllText("testdata/organization_api_key_with_value.json");
        ...
        public async Task TestListOrganizationApiKeysAutoPagingAsync()
        {
            ...
            var items = new List<OrganizationApiKey>();
        ...
        public async Task TestError401()
        {
            ...
            await Assert.ThrowsAsync<AuthenticationException>(() => this.service.ListOrganizationApiKeysAsync("test_organizationId", new ApiKeysListOrganizationApiKeysOptions()));
        }
        ...
        public async Task TestError404()
        {
            ...
            await Assert.ThrowsAsync<NotFoundException>(() => this.service.ListOrganizationApiKeysAsync("test_organizationId", new ApiKeysListOrganizationApiKeysOptions()));
        }
        ...
        public async Task TestError422()
        {
            ...
            await Assert.ThrowsAsync<UnprocessableEntityException>(() => this.service.ListOrganizationApiKeysAsync("test_organizationId", new ApiKeysListOrganizationApiKeysOptions()));
        }
        ...
        public async Task TestError429()
        {
            ...
            await Assert.ThrowsAsync<RateLimitExceededException>(() => this.service.ListOrganizationApiKeysAsync("test_organizationId", new ApiKeysListOrganizationApiKeysOptions()));
        }
        ...
        public async Task TestError500()
        {
            ...
            await Assert.ThrowsAsync<ServerException>(() => this.service.ListOrganizationApiKeysAsync("test_organizationId", new ApiKeysListOrganizationApiKeysOptions()));
        }
    }
}
