...
namespace WorkOS
{
    ...
    public class AuthenticationSSOTimedOutData : WorkOSEntity<AuthenticationSSOTimedOutData>
    {
        [JsonProperty("type")]
        ...
        public AuthenticationSSOTimedOutDataSSO SSO { get; set; }

        /// <summary>Details about the authentication error.</summary>
        [JsonProperty("error")]
        [STJS.JsonPropertyName("error")]
        public AuthenticationSSOTimedOutDataError Error { get; set; }
    }
}
