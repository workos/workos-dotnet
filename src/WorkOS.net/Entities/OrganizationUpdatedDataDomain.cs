...
namespace WorkOS
{
    ...
    /// <summary>Represents a organization updated data domain.</summary>
    public class OrganizationUpdatedDataDomain : WorkOSEntity<OrganizationUpdatedDataDomain>
    {
        ...
        public OrganizationUpdatedDataDomainState? State { get; set; }
        ...
        public OrganizationUpdatedDataDomainVerificationStrategy? VerificationStrategy { get; set; }
