...
namespace WorkOS
{
    ...
    public class OrganizationMembershipDeletedData : WorkOSEntity<OrganizationMembershipDeletedData>
    {
        ...
        public OrganizationMembershipDeletedDataStatus Status { get; set; }
