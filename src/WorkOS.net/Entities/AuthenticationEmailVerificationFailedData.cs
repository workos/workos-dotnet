...
namespace WorkOS
{
    ...
    public class AuthenticationEmailVerificationFailedData : WorkOSEntity<AuthenticationEmailVerificationFailedData>
    {
        [JsonProperty("type")]
        ...
        public AuthenticationEmailVerificationFailedDataError Error { get; set; }
    }
}
