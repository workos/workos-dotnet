...
namespace WorkOS
{
    ...
    public class ConnectionSAMLCertificateRenewalRequired : WorkOSEntity<ConnectionSAMLCertificateRenewalRequired>
    {
        ...
        public ConnectionSAMLCertificateRenewalRequiredData Data { get; set; }
