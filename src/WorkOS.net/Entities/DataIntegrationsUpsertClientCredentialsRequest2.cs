...
namespace WorkOS
{
    ...
    /// <summary>Represents a data integrations upsert client credentials request2.</summary>
    public class DataIntegrationsUpsertClientCredentialsRequest2
    {
        ...
        /// <summary>The exact connected account to reauthorize. The reauthorize intent may be omitted for compatibility.</summary>
