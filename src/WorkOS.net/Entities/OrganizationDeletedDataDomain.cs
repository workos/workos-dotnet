...
namespace WorkOS
{
    ...
    /// <summary>Represents a organization deleted data domain.</summary>
    public class OrganizationDeletedDataDomain : WorkOSEntity<OrganizationDeletedDataDomain>
    {
        ...
        public OrganizationDeletedDataDomainState? State { get; set; }
        ...
        public OrganizationDeletedDataDomainVerificationStrategy? VerificationStrategy { get; set; }
