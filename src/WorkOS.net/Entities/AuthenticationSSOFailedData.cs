...
namespace WorkOS
{
    ...
    public class AuthenticationSSOFailedData : WorkOSEntity<AuthenticationSSOFailedData>
    {
        [JsonProperty("type")]
        ...
        public AuthenticationSSOFailedDataSSO SSO { get; set; }

        /// <summary>Details about the authentication error.</summary>
        [JsonProperty("error")]
        [STJS.JsonPropertyName("error")]
        public AuthenticationSSOFailedDataError Error { get; set; }
    }
}
