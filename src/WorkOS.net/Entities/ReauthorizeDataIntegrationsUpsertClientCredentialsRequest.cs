...
namespace WorkOS
{
    ...
    /// <summary>Represents a reauthorize data integrations upsert client credentials request.</summary>
    public class ReauthorizeDataIntegrationsUpsertClientCredentialsRequest
    {
        ...
        public string ConnectionIntent { get; internal set; } = "reauthorize";
