...
namespace WorkOS
{
    ...
    /// <summary>Represents an application credentials create response.</summary>
    public class ApplicationCredentialsCreateResponse
    {
        ...
        /// <summary>The plaintext secret. Only returned at creation time and cannot be retrieved again.</summary>
        [JsonProperty("secret")]
