...
namespace WorkOS
{
    ...
    public class AuthenticationPasswordFailedData : WorkOSEntity<AuthenticationPasswordFailedData>
    {
        [JsonProperty("type")]
        ...
        public AuthenticationPasswordFailedDataError Error { get; set; } = default!;
    }
}
