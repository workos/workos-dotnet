...
namespace WorkOS
{
    ...
    public class SessionRevokedData : WorkOSEntity<SessionRevokedData>
    {
        ...
        public SessionRevokedDataImpersonator? Impersonator { get; set; }
        ...
        public SessionRevokedDataAuthMethod AuthMethod { get; set; }

        /// <summary>The current status of the session.</summary>
        [JsonProperty("status")]
        [STJS.JsonPropertyName("status")]
        public SessionRevokedDataStatus Status { get; set; }
